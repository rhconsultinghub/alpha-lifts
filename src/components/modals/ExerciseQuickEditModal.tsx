    ...
    <div style={{ position: 'absolute', inset: 0, background: '#0f0e0d', zIndex: 20, overflowY: 'auto' }} className="scr">
      <div style={{ padding: '18px 20px 40px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 18 }}>
          <button aria-label="Close" onClick={q.close} style={{ background: 'rgba(255,255,255,.08)', border: 'none', color: '#f5f0ea', width: 30, height: 30, borderRadius: '50%', fontSize: 14 }}>✕</button>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'rgba(255,255,255,.06)', borderRadius: 14, padding: 8, marginBottom: 22 }}>
          <button aria-label="Decrease" onClick={q.decSets} style={{ width: 40, height: 40, flex: 'none', borderRadius: 10, border: 'none', background: 'rgba(255,255,255,.1)', color: '#f5f0ea', fontSize: 18 }}>–</button>
          <div className="num" style={{ flex: 1, textAlign: 'center', fontSize: 18, fontWeight: 700 }}>{q.sets} sets</div>
          <button aria-label="Increase" onClick={q.incSets} style={{ width: 40, height: 40, flex: 'none', borderRadius: 10, border: 'none', background: 'rgba(255,255,255,.1)', color: '#f5f0ea', fontSize: 18 }}>+</button>
        </div>
        ...
        {!q.isBodyweight && (
          <>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'rgba(255,255,255,.06)', borderRadius: 14, padding: 8, marginBottom: q.platesText ? 4 : 22 }}>
              <button aria-label="Decrease" onClick={q.decWeight} style={{ width: 40, height: 40, flex: 'none', borderRadius: 10, border: 'none', background: 'rgba(255,255,255,.1)', color: '#f5f0ea', fontSize: 18 }}>–</button>
              <input type="number" value={q.weight} onChange={(e) => q.setWeight(parseFloat(e.target.value) || 0)} style={{ flex: 1, textAlign: 'center', fontSize: 18 }} />
              <button aria-label="Increase" onClick={q.incWeight} style={{ width: 40, height: 40, flex: 'none', borderRadius: 10, border: 'none', background: 'rgba(255,255,255,.1)', color: '#f5f0ea', fontSize: 18 }}>+</button>
            </div>
            {q.platesText && (
        ...
        {q.isTime ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 22 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
              <button aria-label="Decrease" onClick={q.decReps} style={{ width: 30, height: 30, flex: 'none', borderRadius: 8, border: 'none', background: 'rgba(255,255,255,.08)', color: 'rgba(245,240,234,.7)', fontSize: 14 }}>–</button>
              <span style={{ font: "500 11px 'Inter'", color: 'rgba(245,240,234,.4)' }}>adjust 5s</span>
              <button aria-label="Increase" onClick={q.incReps} style={{ width: 30, height: 30, flex: 'none', borderRadius: 8, border: 'none', background: 'rgba(255,255,255,.08)', color: 'rgba(245,240,234,.7)', fontSize: 14 }}>+</button>
            </div>
          </div>
        ) : (
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'rgba(255,255,255,.06)', borderRadius: 14, padding: 8, marginBottom: 22 }}>
            <button aria-label="Decrease" onClick={q.decReps} style={{ width: 40, height: 40, flex: 'none', borderRadius: 10, border: 'none', background: 'rgba(255,255,255,.1)', color: '#f5f0ea', fontSize: 18 }}>–</button>
            <input type="number" value={q.reps} onChange={(e) => q.setReps(parseInt(e.target.value) || 0)} style={{ flex: 1, textAlign: 'center', fontSize: 18 }} />
            <button aria-label="Increase" onClick={q.incReps} style={{ width: 40, height: 40, flex: 'none', borderRadius: 10, border: 'none', background: 'rgba(255,255,255,.1)', color: '#f5f0ea', fontSize: 18 }}>+</button>
          </div>
        )}
